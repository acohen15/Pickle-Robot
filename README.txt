pickle.py is a file containing three functions plus one supporting function for the Pickle Robot Python challenge. testpickle.py is a
test file for one of the functions in pickle.py. words_alpha.txt is a file of all English words which I downloaded from the dwyl GitHub
